...
def process_data(conn):
    ...
    #Data Frame to hold the data related to products,departments and categories
    ...
    # Data Frame to hold the data related to customers
    df_customers = pd.read_sql("SELECT customer_id, customer_fname, customer_lname, customer_email,\
                                   ...
                                   conn)
    # Data Frame to hold the data related to revenue generated grouped by order date and product id
    ...
    # Intermediate data frame to get revenue of complete orders
    ...
    # Intermediate data frame to get counts of different order status
    ...
    # Dataframe for calculating revenue and counts of order status on daily basis obtained by joining above two dfs
